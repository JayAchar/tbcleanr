...
saveRDS(chr_str, "inst/testdata/date_format_chr_str.rds")
...
chr_posix <- structure(list(APID = "XYZ1", 
                       ...
                       row.names = c(NA,-1L), 
                       class = c("tbl_df", "tbl", "data.frame", "epiinfo"))
saveRDS(chr_posix, "inst/testdata/date_format_chr_posix.rds")
...
posix <- structure(list(APID = "XYZ1", 
                   ...
                   row.names = c(NA,-1L), 
                   class = c("tbl_df", "tbl", "data.frame", "epiinfo"))
saveRDS(posix, "inst/testdata/date_format_posix.rds")
